...
com = genfromtxt("slope_real/com.csv", delimiter=",")
plt.plot(com[:,0], com[:,1], 'r', linewidth=2.0, label="CoM")

sample_data = genfromtxt("slope_real/boundary.csv", delimiter=",")
...
plt.plot(sample_data[:,4], sample_data[:,5], 'b-', linewidth=3.0, label="Fourth phase")
plt.plot(sample_data[:,6], sample_data[:,7], 'g--', linewidth=3.0, label="End fo motion")

des_com = genfromtxt("slope_real/des_com.csv", delimiter=",")
...
fig.savefig("fig_slope_real.png", dpi=150)
plt.show()
